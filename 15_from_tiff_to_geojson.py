# https://github.com/millermuttu/tiff-to-geojson/blob/master/tiff_geojson_NDVI_colormap.ipynb
...
tiff_name = 'average_ndvi_results/ndvi.tiff'
...
gpd_polygonized_raster.to_file('tiff1212.csv', driver='GeoJSON')

with rasterio.open(tiff_name) as file:
    print(file.count)
